...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'booking.services' => 'getBooking_ServicesService',
            ...
            'fos_facebook.user.login' => 'getFosFacebook_User_LoginService',
            ...
            'mail.services' => 'getMail_ServicesService',
            ...
            'security.authentication.customized_success_handler' => 'getSecurity_Authentication_CustomizedSuccessHandlerService',
            ...
            'trip.registration.form.type' => 'getTrip_Registration_Form_TypeService',
            'twig' => 'getTwigService',
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('/usr/bin/node', array());
    ...
    /**
     * Gets the 'booking.services' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trip\BookingEngineBundle\DependencyInjection\BookingServices A Trip\BookingEngineBundle\DependencyInjection\BookingServices instance.
     */
    protected function getBooking_ServicesService()
    {
        return $this->services['booking.services'] = new \Trip\BookingEngineBundle\DependencyInjection\BookingServices($this->get('doctrine.orm.default_entity_manager'), $this, $this->get('session'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'justtrip', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Trip\\BookingEngineBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Trip\\SiteManagementBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Trip\\SecurityBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Trip\\BookingEngineBundle\\Entity');
        $c->addDriver($b, 'Trip\\SiteManagementBundle\\Entity');
        $c->addDriver($b, 'Trip\\SecurityBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('TripBookingEngineBundle' => 'Trip\\BookingEngineBundle\\Entity', 'TripSiteManagementBundle' => 'Trip\\SiteManagementBundle\\Entity', 'TripSecurityBundle' => 'Trip\\SecurityBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_06e033d46940f43e222b2893e057f7de7592f277731ba55d6f8192fa231bff35');
    ...
    {
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => '524006397762005', 'secret' => '535eb9bac23e4477af88272709e620a3', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), $this->get('router'), true, 'en_US', array(0 => 'email'));
    }
    ...
    /**
     * Gets the 'fos_facebook.user.login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trip\SecurityBundle\Controller\FacebookProvider A Trip\SecurityBundle\Controller\FacebookProvider instance.
     */
    protected function getFosFacebook_User_LoginService()
    {
        return $this->services['fos_facebook.user.login'] = new \Trip\SecurityBundle\Controller\FacebookProvider($this->get('fos_facebook.api'), $this->get('fos_user.user_manager'), $this->get('validator'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('noreply@justtrip.in' => 'Just Trip'), 'resetting' => array('noreply@justtrip.in' => 'Just Trip'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'trip_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'mail.services' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trip\SiteManagementBundle\DependencyInjection\MailServices A Trip\SiteManagementBundle\DependencyInjection\MailServices instance.
     */
    protected function getMail_ServicesService()
    {
        return $this->services['mail.services'] = new \Trip\SiteManagementBundle\DependencyInjection\MailServices($this->get('doctrine.orm.default_entity_manager'), $this, $this->get('session'));
    }
    ...
    /**
     * Gets the 'security.authentication.customized_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trip\SecurityBundle\Controller\LoginSuccessHandler A Trip\SecurityBundle\Controller\LoginSuccessHandler instance.
     */
    protected function getSecurity_Authentication_CustomizedSuccessHandlerService()
    {
        return $this->services['security.authentication.customized_success_handler'] = new \Trip\SecurityBundle\Controller\LoginSuccessHandler($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = $this->get('fos_facebook.user.login');
        ...
        $g = $this->get('security.authentication.customized_success_handler');
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'trip_site_management_homepage'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($h, $l, array(), $a);
        $n->setOptions(array('login_path' => 'trip_site_management_homepage', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c)), 1 => $b, 2 => $c), 'main', $a, $e), 2 => $m, 3 => new \FOS\FacebookBundle\Security\Firewall\FacebookListener($d, $i, $j, $l, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($g, array('login_path' => 'trip_site_management_homepage', 'default_target_path' => '/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $n, array('app_url' => '//apps.facebook.com//justtrip', 'server_url' => 'www.justtrip.in', 'check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'display' => 'page', 'create_user_if_not_exists' => false, 'redirect_to_facebook_login' => true), $a, $e), 4 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $i, $j, $l, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($g, array('login_path' => 'fos_user_security_login', 'use_referer' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'), 'main'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($g, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $e, NULL), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5b6c233f933b80.75272177', $a, $i), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $this->get('security.access.decision_manager'), $k, $i)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($h, $l, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('noreply@justtrip.in');
        $a->setPassword('Walk@123');
        $a->setAuthMode('login');
        ...
        $instance->setHost('mail.exclusivehosting.net');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Trip\\BookingEngineBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Trip\\SiteManagementBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Trip\\SecurityBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    /**
     * Gets the 'trip.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trip\SecurityBundle\Form\Type\RegistrationFormType A Trip\SecurityBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getTrip_Registration_Form_TypeService()
    {
        return $this->services['trip.registration.form.type'] = new \Trip\SecurityBundle\Form\Type\RegistrationFormType('Trip\\SecurityBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\facebook-bundle\\FOS\\FacebookBundle/Resources/views'), 'FOSFacebook');
        $instance->addPath(($this->targetDirs[3].'\\src\\Trip\\BookingEngineBundle/Resources/views'), 'TripBookingEngine');
        $instance->addPath(($this->targetDirs[3].'\\src\\Trip\\SiteManagementBundle/Resources/views'), 'TripSiteManagement');
        $instance->addPath(($this->targetDirs[3].'\\src\\Trip\\SecurityBundle/Resources/views'), 'TripSecurity');
        $instance->addPath(($this->targetDirs[3].'\\src\\Trip\\RestBundle/Resources/views'), 'TripRest');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \FOS\FacebookBundle\Security\Authentication\Provider\FacebookProvider('main', $this->get('fos_facebook.api'), $this->get('fos_facebook.user.login'), $a, false), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $a, 'main', $this->get('security.encoder_factory'), true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b6c233f933b80.75272177')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ALLOWED_TO_SWITCH', 2 => 'ROLE_SARATI')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TripBookingEngineBundle' => 'Trip\\BookingEngineBundle\\TripBookingEngineBundle',
                'TripSiteManagementBundle' => 'Trip\\SiteManagementBundle\\TripSiteManagementBundle',
                'TripSecurityBundle' => 'Trip\\SecurityBundle\\TripSecurityBundle',
                'TripRestBundle' => 'Trip\\RestBundle\\TripRestBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'justtrip',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.exclusivehosting.net',
            'mailer_user' => 'noreply@justtrip.in',
            'mailer_password' => 'Walk@123',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.exclusivehosting.net',
            'swiftmailer.mailer.default.transport.smtp.username' => 'noreply@justtrip.in',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Walk@123',
            ...
            'fos_user.model.user.class' => 'Trip\\SecurityBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'noreply@justtrip.in' => 'Just Trip',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'trip_registration',
            ...
            'fos_facebook.app_id' => '524006397762005',
            'fos_facebook.secret' => '535eb9bac23e4477af88272709e620a3',

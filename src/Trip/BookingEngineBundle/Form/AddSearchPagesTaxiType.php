...
class AddSearchPagesTaxiType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Trip\BookingEngineBundle\Entity\DestinationTaxitype'
    ...
    {
        return 'trip_booking_engine_add_searchpagestaxitype';
    }
}

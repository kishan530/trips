...
class EditBikeMainCityType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Trip\SiteManagementBundle\Entity\BikesCityMain'
        ));
    }
    ...
    {
        return 'trip_site_management_edit_bikes_maincity';
    }
}
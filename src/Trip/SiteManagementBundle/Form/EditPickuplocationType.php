...
class EditPickuplocationType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
      $resolver->setDefaults(array(
           'data_class' => 'Trip\SiteManagementBundle\Entity\StartPoint'
       ));
    }
    ...
    {
        return 'trip_site_management_edit_pickup_location';
    }
}

...
class CatalogueService
{
    ...
    public function getAmenities(){
    	$locations = $this->em->getRepository('TripSiteManagementBundle:Amenities')->findAll();
    	return $locations;
    }
    public function getHotels(){
    	$locations = $this->em->getRepository('TripSiteManagementBundle:Hotel')->findAll();
    	return $locations;
    }
    public function getBookings(){
    	$locations = $this->em->getRepository('TripBookingEngineBundle:Booking')->findAll();
    	return $locations;
    }
    public function getCustomers(){
    	$locations = $this->em->getRepository('TripSiteManagementBundle:Customer')->findAll();
    	return $locations;
    }
